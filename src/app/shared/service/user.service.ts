...
export class UserService {
  ...
  constructor() {
    ...
    if (access_token) {
      const decodedTokenSubject = jwtDecode(access_token).sub as unknown as LoggedInUser; // If the user is already logged in, set the user signal to keep the user logged in after refreshing the page.
      this.user.set({
